        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('joueurs.update', $joueur) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="nom" class="block w-full mt-1" type="text" name="nom" :value="old('nom', $joueur->nom)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="prenom" class="block w-full mt-1" type="text" name="prenom" :value="old('prenom', $joueur->prenom)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="email" class="block w-full mt-1" type="email" name="email" :value="old('email', $joueur->email)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="numero_telephone" class="block w-full mt-1" type="text" name="numero_telephone" :value="old('numero_telephone', $joueur->numero_telephone)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="sexe" name="sexe" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600" required>
                                ...
                                <option value="M" {{ old('sexe', $joueur->sexe) == 'M' ? 'selected' : '' }}>{{ __('Masculin') }}</option>
                                <option value="F" {{ old('sexe', $joueur->sexe) == 'F' ? 'selected' : '' }}>{{ __('Féminin') }}</option>
                                <option value="Autre" {{ old('sexe', $joueur->sexe) == 'Autre' ? 'selected' : '' }}>{{ __('Autre') }}</option>
                            </select>
